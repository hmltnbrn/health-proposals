...
(function () {
  ...
  document.addEventListener('click', function (e) {
    if (e.target && e.target.id == 'compare-input') {
      ...
      d3.selectAll(".compare-".concat(e.target.id.split("-")[1])).uncheck();
      var event = new Event('change');
      document.querySelector(".compare-".concat(e.target.id.split("-")[1])).dispatchEvent(event);
    }
  });
  ...
  function renderDesktop(proposals) {
    ...
    circles.enter().append("circle").attr(circleAttrs).on("mouseover", mouseOver).on("mouseout", function (d) {
      if (clicked.indexOf(d.id) === -1) {
        moused[d.id] = false;
        d3.select(".tooltip-".concat(d.id)).transition().style("opacity", 0);
        d3.selectAll(".tooltip-".concat(d.id)).remove();
      ...
      if (index === -1) {
        ...
        d3.select(".full-tooltip-".concat(d.id)).transition().style("opacity", 0);
        d3.selectAll(".full-tooltip-".concat(d.id)).remove();
        setTimeout(function () {
          redoOptions();
          updateTooltips(d);
        }, 0);
    ...
    function mouseOver(d) {
      if (clicked.indexOf(d.id) === -1) {
        ...
        var div = d3.select("#timeline-container").append("div").attr("class", "viz-tooltip tooltip-".concat(d.id, " tooltip-x-").concat(d.x)).style("opacity", 0);
        div.html("\n          <h2 class=\"tooltip-name\">".concat(d.name, "</h2>\n          <div class=\"compare-bottom\">\n            <div class=\"compare-check\">\n              <label>\n                <input type=\"checkbox\" id=\"compare-input\" class=\"compare-").concat(d.id, "\" ").concat(disableEnable, "><span class=\"outer-span\"><span>COMPARE</span> <i class=\"material-icons\">radio_button_unchecked</i></span>\n              </label>\n            </div>\n          </div>\n        ")).style("width", "calc(100%/".concat(proposalsLength, ")")).style("left", "calc(100%/".concat(proposalsLength, "*").concat(d.x, ")")).style("top", 20 + (140 * sectionActive[d.x] - 140) + "px");
        ...
        var div = d3.select("#timeline-container").append("div").attr("class", "viz-tooltip tooltip-".concat(d.id, " tooltip-x-").concat(d.x)).style("opacity", 0);
        div.html("\n          <h2 class=\"tooltip-name\">".concat(d.name, "</h2>\n          <div class=\"compare-bottom\">\n            <div class=\"compare-check\">\n              <label>\n                <input type=\"checkbox\" id=\"compare-input\" class=\"compare-").concat(d.id, "\" ").concat(_disableEnable, "><span class=\"outer-span\"><span>COMPARE</span> <i class=\"material-icons\">radio_button_unchecked</i></span>\n              </label>\n            </div>\n          </div>\n        ")).style("width", "calc(100%/".concat(proposalsLength, ")")).style("left", "calc(100%/".concat(proposalsLength, "*").concat(d.x, ")")).style("top", 20 + (140 * sectionActive[d.x] - 140) + "px");
        div.transition().style("opacity", 1);
        toggleCompareDivs(d);
      }
    }
    ...
    function toggleCompareDivs(d) {
      document.querySelector(".compare-".concat(d.id)).addEventListener("change", function (e) {
        ...
        if (checked && index === -1 && activeFullTools < 2) {
          ...
          checking.push(d.id);
          var divs = d3.select(".compare-proposal-container").append("div").attr("class", "full-tooltip full-tooltip-".concat(d.id)).style("opacity", 0);
    ...
    function setFullTooltopHtml(d) {
      if (system === "federal") {
        ...
        return "\n          <div class=\"option-head\">\n            <h4 class=\"option-head-number\">Option ".concat(checking.length, "</h4>\n            <div class=\"close-full-tooltip\">\n              <i id=\"close-").concat(d.id, "\" class=\"material-icons x-full-tooltip\">close</i>\n            </div>\n          </div>\n          <h2>").concat(d.name, "</h2>\n          <h3>Sponsor</h3>\n          <p>").concat(d.sponsor, "</p>\n          <h3>New Coverage Enhancement or Option</h3>\n          <p>").concat(d.enhancement, "</p>\n          <h3>Who Is Eligible?</h3>\n          <p>").concat(d.eligibility, "</p>\n          <h3>How Do People Pay for Coverage and Health Care?</h3>\n          <p>").concat(d.cost, "</p>\n          <h3>How Are Health Care Costs Managed?</h3>\n          <p>").concat(d.management, "</p>\n          <h3>").concat(transitionHeader, "</h3>\n          <p>").concat(transitionText, "</p>\n          <a href=\"").concat(d.link, "\" target=\"_blank\">Read the bill</a>\n        ");
      } else if (system === "international") {
        return "\n          <div class=\"option-head\">\n            <h4 class=\"option-head-number\">Option ".concat(checking.length, "</h4>\n            <div class=\"close-full-tooltip\">\n              <i id=\"close-").concat(d.id, "\" class=\"material-icons x-full-tooltip\">close</i>\n            </div>\n          </div>\n          <h2>").concat(d.name, "</h2>\n          <h3>How Are People Covered?</h3>\n          <p>").concat(d.coverage.text, "</p>\n          <ul>\n            ").concat(d.coverage.bullets.map(function (b) {
          return "<li>".concat(b, "</li>");
        }).join(""), "\n          </ul>\n          <h3>How Do People Pay for Coverage and Health Care?</h3>\n          ").concat(d.cost.map(function (c) {
          return "<p>".concat(c, "</p>");
        }).join(""), "\n          <h3>How Are Health Care Costs Managed?</h3>\n          ").concat(d.management.map(function (m) {
          return "<p>".concat(m, "</p>");
        }).join(""), "\n          ").concat(d.links.map(function (l) {
          return "<a href=\"".concat(l.link, "\" target=\"_blank\">").concat(l.text, "</a>");
        }).join(""), "\n        ");
      }
    }
    ...
    function redoOptions() {
      d3.selectAll(".full-tooltip").each(function (d, i) {
        d3.select(this).select(".option-head-number").text("Option ".concat(i + 1));
      });
    ...
    function updateTooltips(d) {
      d3.selectAll(".tooltip-x-".concat(d.x)).each(function (d, i) {
